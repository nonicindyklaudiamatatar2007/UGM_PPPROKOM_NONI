...
# -----------------------------
# FONTS (Using default font)
# -----------------------------
try:
    title_font = ImageFont.truetype("/usr/share/fonts/dejavu/DejaVuSans-Bold.ttf", 48)
    section_font = ImageFont.truetype("/usr/share/fonts/dejavu/DejaVuSans-Bold.ttf", 36)
    text_font = ImageFont.truetype("/usr/share/fonts/dejavu/DejaVuSans.ttf", 28)
except:
